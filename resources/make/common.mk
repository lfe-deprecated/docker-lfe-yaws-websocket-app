...
ERL_LIBS=.:..:../sample-app:$(shell $(LFETOOL) info erllibs)
OS := $(shell uname -s)
ifeq ($(OS),Linux)
        HOST=$(HOSTNAME)
endif
...
get-version:
	...
	-eval "lfe_io:format(\"~p~n\",['sample-app-util':'get-versions'()])." \
...
upload: $(EXPM) get-version
	@echo "Preparing to upload sample-app ..."
	@echo
	@echo "Package file:"
	@echo
	@cat package.exs
